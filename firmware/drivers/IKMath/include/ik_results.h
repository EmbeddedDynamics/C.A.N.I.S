...
enum {
    ...
    IK_ERROR_CORDIC_TIMEOUT         = IK_RESULT_CORDIC_BASE + 11u,
    IK_ERROR_CORDIC_NO_RESULTS      = IK_RESULT_CORDIC_BASE + 12u,
    IK_ERROR_CORDIC_NO_AVAILABLE_JOB = IK_RESULT_CORDIC_BASE + 13u,
